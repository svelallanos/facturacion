<div class="col-12 mt-4">
    ...
    <div class="card card-warning">
        ...
        <h3 class="card-title">EMITIR BOLETA ELECTRONICA</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form id="frmVenta" submit="return false">
            ...
            <div class="card-body">
                ...
                <button type="button" class="btn btn-primary" onclick="agregar_bolsa()"><i class="fa fa-save"></i> Agregar Bolsa Plástica</button>
            </div>
            <!-- /.card-body -->
...
<script>
    ...
    $("#tipocomp").val('03'); //valor por defecto de factura 01
    ConsultarSerie();
    listar_emisores();
    listar_monedas();
    listar_comprobantes();
    ...
    function agregar_bolsa(){
        $.ajax({
            ...
            url: "apifacturacion/controlador/controlador.php",
            data: {
                "accion": "ADD_PRODUCTO_BOLSA_GRATUITA"
            }
        }).done(function(resultado){
            $('#div_carrito').html(resultado);
        })
