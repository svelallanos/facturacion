...
$detalle = array(
    ...
    array(
        ...
        //IMPORTANTE
        'tipo_afectacion_igv'   =>  '20', //Catálogo No. 07: Códigos de tipo de afectación del IGV: 10:GRA, 20:EXO, 30:INA
        'codigo_tipo_tributo'   =>  '9997', //Catálogo No. 05: Códigos de tipos de tributos
        'tipo_tributo'          =>  'VAT', //Catálogo No. 05: Códigos de tipos de tributos
        'nombre_tributo'        =>  'EXO', //Catálogo No. 05: Códigos de tipos de tributos
    ),
    array(
        'item'              =>  3,
        'codigo'            =>  'PROD003',
        ...
        //IMPORTANTE
        'tipo_afectacion_igv'   =>  '30', //Catálogo No. 07: Códigos de tipo de afectación del IGV: 10:GRA, 20:EXO, 30:INA
        'codigo_tipo_tributo'   =>  '9998', //Catálogo No. 05: Códigos de tipos de tributos
        'tipo_tributo'          =>  'FRE', //Catálogo No. 05: Códigos de tipos de tributos
        'nombre_tributo'        =>  'INA', //Catálogo No. 05: Códigos de tipos de tributos
    )
);
...
//PASO 01 - CREAR EL XML DE NOTA DE CREDITO
...
$api_xml->crea_xml_notacredito($rutaXML . $nombreXML, $emisor, $cliente, $comprobante, $detalle);
echo '</br> PARTE 01 - CREAR XML DE NOTA DE CREDITO';
