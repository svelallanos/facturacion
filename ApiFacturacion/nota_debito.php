...
//PASO 01 - CREAR EL XML DE NOTA DE DEBITO
...
$api_xml->crea_xml_notadebito($rutaXML . $nombreXML, $emisor, $cliente, $comprobante, $detalle);
echo '</br> PARTE 01 - CREAR XML DE NOTA DE DEBITO';
